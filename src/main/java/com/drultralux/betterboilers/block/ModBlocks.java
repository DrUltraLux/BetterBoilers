...
public class ModBlocks {
    ...
    public static final BlockTurbineCasing CASING = new BlockTurbineCasing();//needs proper texture, proper calculation
    public static final BlockTurbineShaft SHAFT = new BlockTurbineShaft(); //needs proper texture//needs proper texture
