 ...
 * BlockFluidPipe for the full explanation, this is the same pattern for heat.
 */
public class BlockHeatPipe extends BlockTileEntity<TileEntityHeatPipe> {
    ...
    @Override
    public Class<TileEntityHeatPipe> getTileEntityClass() {
        return TileEntityHeatPipe.class;
    }

    @Nullable
    @Override
    public TileEntityHeatPipe createTileEntity(World world, IBlockState state) {
